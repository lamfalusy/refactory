...
<div class="page-content">
	...
	<div class="form-editor ticket-form">
		...
		<div class="form-editor-content">
			<div
				class="form-editor-content-descriptor-narrow ticket-editor-content-descriptor content-panel">
				<fieldset
					class="ticket-editor-details-fieldset fieldset-input-fixed-height">
			...
			<div class="form-editor-content-descriptor-narrow-second">
				<fieldset
					class="ticket-editor-people-fieldset fieldset-input-fixed-height">
					<legend>People</legend>
					<div>
						<span class="attribute-name">Reporter:</span> <span
							id="ticket-editor-input-reporter"
				...
				<fieldset
					class="ticket-editor-dated-fieldset fieldset-input-fixed-height">
					<legend>Dates</legend>
					<div>
